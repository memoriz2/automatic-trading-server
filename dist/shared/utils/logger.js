...
class Logger {
     ...
     */
    websocket = {
        debug: (message, contextOrData) => this.debug(`[WS] ${message}`, contextOrData),
        info: (message, contextOrData) => this.info(`[WS] ${message}`, contextOrData),
        warn: (message, contextOrData) => this.warn(`[WS] ${message}`, contextOrData),
        error: (message, error, context) => this.error(`[WS] ${message}`, error, context),
    };
    /**
     * 동기화 관련 로그
     */
    sync = {
        debug: (message, contextOrData) => this.debug(`[SYNC] ${message}`, contextOrData),
        info: (message, contextOrData) => this.info(`[SYNC] ${message}`, contextOrData),
        warn: (message, contextOrData) => this.warn(`[SYNC] ${message}`, contextOrData),
        error: (message, error, context) => this.error(`[SYNC] ${message}`, error, context),
    };
    /**
     * 성능 측정 시작
     */
...
// 편의 함수들
export const log = {
    debug: (message, contextOrData) => logger.debug(message, contextOrData),
    info: (message, contextOrData) => logger.info(message, contextOrData),
    trade: (message, context) => logger.trade(message, context),
    warn: (message, contextOrData) => logger.warn(message, contextOrData),
...
export const logWarn = (message, contextOrData) => log.warn(message, contextOrData);
export const logInfo = (message, contextOrData) => log.info(message, contextOrData);
export const logDebug = (message, contextOrData) => log.debug(message, contextOrData);
...
export const performanceLogger = {
    start: (label) => logger.timeStart(label),
    end: (label) => logger.timeEnd(label)
};
