        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    // 간단한 ping 쿼리
                    return [4 /*yield*/, prisma.$queryRawUnsafe('select 1')];
                case 1:
                    // 간단한 ping 쿼리
                    _b.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    return [4 /*yield*/, prisma.cryptocurrency.findUnique({ where: { symbol: 'BTC' } })];
                case 1:
                    btc = _a.sent();
                    if (!!btc) return [3 /*break*/, 3];
                    return [4 /*yield*/, prisma.cryptocurrency.createMany({
                            data: [
...
// 초기화 루틴 (필요시)
initializeTestData().catch(function () { });
