            ...
            const stats = {
                ...
                total_profit_krw: (() => {
                    ...
                    for (const position of todayExitedPositions) {
                        ...
                        const binanceSell = positionTrades.find(t => t.exchange === 'binance' && (t.side === 'sell' || t.side === 'short')); // 숏 진입
                        const binanceBuy = positionTrades.find(t => t.exchange === 'binance' && (t.side === 'buy' || t.side === 'cover')); // 숏 청산
                        // 업비트 손익 (KRW)
