    ...
    async executeRealForceEntry(userId, params) {
        ...
        try {
         ...
         LIMIT 1`, [userId]);
            ...
            let actualUpbitPrice;
            let actualUpbitQuantity;
            let actualBinancePrice;
            ...
            if (upbitOrderDetail.trades && upbitOrderDetail.trades.length > 0) {
                ...
                let totalFunds = 0;
                let totalVolume = 0;
                upbitOrderDetail.trades.forEach((trade) => {
            ...
            if (needsEntryPriceFix && savedPosition?.id) {
                ...
                this.fixPositionEntryPriceFromTrades(savedPosition.id).catch((err) => {
