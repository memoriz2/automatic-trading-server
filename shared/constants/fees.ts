 ...
 * @returns 수수료 (KRW)
 */
export function calculateUpbitFee(amount: number): number {
 ...
 * @returns 수수료 (USD)
 */
export function calculateBinanceFuturesFee(amount: number): number {
 ...
 */
export function calculateBinanceSpotFee(amount: number, isMaker: boolean = false): number {
